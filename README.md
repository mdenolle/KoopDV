...
* Weather data: can be obtained using [PRISM Climate data](https://prism.oregonstate.edu/). Tim Clements wrote a Julia script to collet the data into a netcdf file, copied in this repos.
* 
